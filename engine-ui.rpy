init -10 python:
    ...
    class UIProvider(object):
        ...
        def PickSkill(self, source, options):
            ...
            renpy.show("UI_PickSkill_Menu", what=sWindow, at_list=[Transform(xpos=450, ypos=450)], layer=l)
            result = self.Interact()
        ...
        def PickSubSkill(self, source, options):
            ...
            renpy.show("UI_PickSubSkill_Menu", what=sWindow, at_list=[Transform(xpos=475, ypos=450)], layer=l)
            result = self.Interact()
