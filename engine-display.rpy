init -10 python:
    ...
    class BattleSprite(BattleDisplayable):
        ...
        def setFacing(self, val):
            #Fix by Terra: This exception was getting raised so I just commented it out.
            #Doesn't seem like this is actually an issue..? Seems to work.
            #The "feature" that shows off the sprite facing works still too.
